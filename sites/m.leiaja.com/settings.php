...
$vPrefix = ($_SERVER['SERVER_ADDR'] != '192.168.201.27') ? 'dev_' : '';
...
if (PHP_OS == 'WINNT' || PHP_OS == 'Darwin') {
    $base_url = 'http://www4.m.leiaja.com';  // NO trailing slash!
} else {
    $base_url = 'http://www3.m.leiaja.com';  // NO trailing slash!
}
...
//module_disable(array('transliteration'));