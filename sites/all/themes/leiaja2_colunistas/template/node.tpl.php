...
?>
<!-- section -->
<section id="content" class="template-node-colunistas">
    <div class="containerInterna">
        ...
        <div class="inner_content">
            ...
            <div class="title">
                <a href="<?= $full_node_url ?>"><h1><?= stripslashes($title) ?></h1></a>
                <?php
            ...
            <div class="content_text">
                ...
                <div class="bottom_inner">
                    ...
                    if (arg(0) == "node"):
                        ...
                        <div class="col right">
                            <iframe src="<?= LEIAJAURL ?>/ultimas_dinamico?response_type=embed&qnt=5&interna" scrolling="no" frameborder="0" width="330" class="zbox hgd10" style="margin-top:0px;border:0px;height:420px;margin-bottom:20px !important"></iframe>
