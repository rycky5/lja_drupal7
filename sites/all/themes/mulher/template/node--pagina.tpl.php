...
<div id="divConteudoExibir">
    ...
    <?php
      if(!empty($node->field_capa["und"][0])){
        echo "<div class='divImg'>";
        echo "<img title='' src='".image_style_url('image_wide_large', $node->field_capa["und"][0]["uri"])."' rel='image_src'>";
        echo "<div class='divImgBg'></div></div>";
      }
