...
<div id="divContainer" class="divContainer bgBranco">
    <div class="divContainerContent <?= $vInfoColunista->style ?>">
    <div class="divMapeamento">
      <ul>
        ...
        <li><a href="<?= url(drupal_lookup_path('alias','taxonomy/term/'.$vInfoColunista->tid),array('absolute' => TRUE)) ?>" title="Mundo" class="active"><?= $vInfoColunista->name ?></a></li>
      </ul>
      <div class="divContentMapeamento">
      	<a href="javascript:void(0);" title="Recomendar" id="aRecomendar" >Recomendar</a>
        <a href="javascript:void(0);" title="Recomendar" id="imgRecomendar" class="btCompartilhar"></a>
        <span>|</span>
        <a href="javascript:void(0);" title="Seguir">Fixar no Mural</a>
        <a href="javascript:void(0);" class="lerDepois" title="Seguir"></a>
      </div>
    </div>
