...
<link rel="stylesheet" href="/sites/all/themes/leiaja2/css/boxes/box0017_8x6_1_iframe/css/box.css"/>

<div class="zbox wgd8 hgd6 box0017" style="border:0px;margin:0px;">
  ...
  <div class="colunas4 divColunistasBloco">  
    ...
    foreach ($arrColuna as $value) {
      ...
      <div class="contentCol <?php print ($count % 4 == 0) ? '' : ' margin-left25'; ?>" id="contentCol<?php print $count + 1; ?>" <?php print (($count <= 3) ? '' : 'style="display:none;"'); ?>>
        <a target="_parent" class="previewmodal<?php print "90$count" ?>" href="/<?php print $urlColuna; ?>" id="linkImg<?php print $count; ?>" title="<?php print $subcategoria ?>">
        ...
        <strong><a target="_parent" class="linksStrong <?php print getCores($parent); ?>" href="/<?php print $urlColuna ?>"><?php print $title_colunista; ?></a></strong>
        <h6 class="colunistaH6">
          <a target="_parent" class="previewmodal<?php print "90$count" ?> links cinza" href="/<?php print $urlNode ?>" id="linkNot<?php print $count; ?>">
