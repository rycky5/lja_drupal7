...
<div class="colunas3" style="">
  <h2 class="tituloH2"><a href="http://www.leiaja.com/tags/imposto-de-renda" class="vermelho" title="Imposto de Renda">Imposto de Renda</a></h2>

<?php

// Recuperando a views do bloco de carnaval
$resultViews        = views_get_view_result('bloco_coberturas', 'imposto_de_renda', $strIgnore);
