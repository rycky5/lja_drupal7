...
<?php
//verificando se houve uma tentativa de login. Se hover falhar, é exibida uma msg
if(isset($_SESSION['msgRetorno'])):
    $msgRetorno = $_SESSION['msgRetorno'];
?>
<script type="text/javascript">
//script especifico para os botões de topo (recomendar e fixar) nas páginas com listagem de nodes
(function ($) {
    $(document).ready(function(){
        compartilhaBottom = $("#loginComment").offset().top;
        compartilha = compartilhaBottom - 100;
...
<?php
//fim da verificacaod e sessão de login
endif;
...
<div class="areaFlexivel<?=$node->nid;?>">
<?php if($node):?>
