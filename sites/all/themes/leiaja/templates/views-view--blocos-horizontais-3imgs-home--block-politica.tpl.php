...
?>
<div class="colunas3">
  <h2 class="tituloH2"><a href="/politica" class="cinza" title="Política">Política</a></h2>

<?php
$resultViews = views_get_view_result('blocos_horizontais_3imgs_home', 'block_politica',api_getNidIgnore());
...
foreach ($resultViews as $key => $value){
    ...
    $tid = $value->_field_data['nid']['entity']->field_catpolitica['und'][0]['tid'];
...
<div class="contentCol <?php print $classeMargem;?>">
    ...
    <strong><a href="<?= url(drupal_lookup_path('alias',"taxonomy/term/".$tid)); ?>" class="linksStrong cinza"><?=$subcategoria ?></a></strong>
