...
<?php
$resultViews = views_get_view_result('blocos_horizontais_3imgs_home', 'block_noticias',api_getNidIgnore());
...
foreach ($resultViews as $key => $value){
    ...
    $tid = $value->_field_data['nid']['entity']->field_catnoticia['pt-br'][0]['tid'];
