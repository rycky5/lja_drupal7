...
.concursos .header {width:630px;height:150px;float:left;background:url(http://www4.leiaja.com/sites/all/themes/leiaja/images/bg_header_concurso.jpg) no-repeat 0px 3px;}
.concursos .header h2 {text-align: right;font-weight: bold;font-size: 30px;color: #7a7979;margin: 40px 0 5px 0;}
.concursos .header h2 .azul {color:#43b5e4;}
.concursos .header h2 .vermelho {color:#ec1c24;}
.concursos .header p {text-align: right;color: #7a7979;font-weight: lighter;width: 340px;position: relative;float: right;}
...
.concursos .lista .item span.data {background: url(http://www4.leiaja.com/sites/all/themes/leiaja/images/data_icone.png) no-repeat 15px 10px;}
.concursos .lista .item span.edital {background: url(http://www4.leiaja.com/sites/all/themes/leiaja/images/edital_icone.png) no-repeat 15px 10px;}
.concursos .lista .item span.salario {background: url(http://www4.leiaja.com/sites/all/themes/leiaja/images/salario_icone.png) no-repeat 15px 10px;}
.concursos .lista .item span.provas {background: url(http://www4.leiaja.com/sites/all/themes/leiaja/images/provas_icone.png) no-repeat 15px 10px;border-bottom:none!important;}
.concursos .lista .banner{position: absolute; width: 90px; height: 40px; margin: 17px 0 0 525px;z-index: 99;}
</style>
