...
$link = $view->result[0]->_field_data["nid"]["entity"]->field_url['und'][0]['value'];
?>
...
<div class="divContainerContent">
  <div class="faixa_urgente_pai">
    <div class="faixa_urgente"> <a href="<?php print $link; ?>" class="faixa_box" style="width: 100%;height: 100%;display: block;"> <span class="logo_faixa"> <img src="<?php print $url_imagem; ?>" border="0" /> </span> <span class="titulo_faixa"> <?php print $titulo; ?> </span> <span class="title_faixa"> <?php print $texto; ?> </span> <span style="color: #0074BC;" class="subtitle_faixa"> assista agora </span> </a> </div>
  </div>
</div>
