...
<div id="page-wrapper">
  <div id="page">
    ...
    <div <?= (!empty($cobertura)) ? '' : 'id="divContainer"'; ?> class="divContainer bgBranco <?= (@$node->type) ? $node->type : ''; ?> caderno_<?= @semAcentos(strtolower($vCadernoNome)); ?>">
      <div class="divContainerContent caderno_esportes">
        ...
        <?php endif; ?>
          <div class="divSubCadernos "><h2><a class="cinza" href="/esportes">Esportes</a></h2><h4><span>|</span>Futebol</h4></div>
        <div class="box_campeonato">
            <iframe class="scroll" frameborder="0" hspace="0" src="http://futebol.leiaja.com?CampeonatoPaiId=<?php print $url;?>" id="TB_iframeContent" name="TB_iframeContent494" style="width:970px;height:650px;z-index: 0;"> </iframe>
        </div>  
