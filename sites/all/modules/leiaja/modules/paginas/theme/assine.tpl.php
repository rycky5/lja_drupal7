...
<h4><a href="<?= url(base_path() . 'assinar', array('absolute' => TRUE)) ?>" title="Leia J&aacute;"><img src="http://www4.leiaja.com/sites/all/themes/leiaja2/images/rss.png" width="32" /><span>Leia J&aacute;</span></a></h4>
<p>Assine nosso conteúdo! Clicando em um ícone RSS (<img src="http://www4.leiaja.com/sites/all/themes/leiaja2/images/rss.png" width="16" />), você terá acesso ao endereço RSS da área desejada.</p>
...
foreach ($array_obj_vocabulary as $vocabulary) {
    ...
    if ($cont % 3 == 0) {
        ...
        <div class="listaRss">
            <h5>
                <a href="<?= base_path() . 'assinar/' . $vocabulary->machine_name; ?>" title="<?= $vocabulary->name; ?>"><img src="http://www4.leiaja.com/sites/all/themes/leiaja2/images/rss.png" width="24" /><span><?= $vocabulary->name; ?></span></a>
            </h5>
            <ul>
                <?php
                ...
                foreach ($terms as $term) {
                    ...
                    //var_dump($alias);
                    ?>
                    <li><a href="<?= base_path() . 'assinar/' . $alias ?>" title="<?= $term->name ?>"><?= $term->name ?></a></li>
                            <?php
                        }
                        ?>
            </ul>
