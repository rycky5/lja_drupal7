...
$vHostBanco = (PHP_OS == 'WINNT' || PHP_OS == 'Darwin') ? '192.168.100.100' : 'bd.leiaja.com';
...
# $base_url = 'http://www.example.com';  // NO trailing slash!
 if(PHP_OS == 'WINNT' || PHP_OS == 'Darwin'){
   $GLOBALS['base_url_static'] = 'http://leiaja';  // NO trailing slash!
 }else{
   $GLOBALS['base_url_static'] = 'http://www3.leiaja.com';  // NO trailing slash!
 }
/**
 * PHP settings:
 *
